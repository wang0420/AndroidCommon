package com.basemodule.ww_test.net.download.break_point;

import android.util.Log;

import com.basemodule.ww_test.net.download.DownloadHelper;
...
import static com.basemodule.ww_test.net.download.DownloadHelper.TEMP_FILE_PATH_NAME;
