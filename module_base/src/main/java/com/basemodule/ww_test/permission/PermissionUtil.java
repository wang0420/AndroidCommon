package com.basemodule.ww_test.permission;
...
public class PermissionUtil {
    ...
    public static boolean hasStoragePermission(Context context) {
        return ZPermission.hasPermissions(context, PermissionGroup.STORAGE);
    }

    public static boolean hasPhoneStatePermission(Context context) {
        return ZPermission.hasPermissions(context, Manifest.permission.READ_PHONE_STATE);
    }

    public static boolean hasLocationPermission(Context context) {
        return ZPermission.hasPermissions(context, PermissionGroup.LOCATION);
    }
    ...
    public static void tipDialog(Context context, int msg) {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //  ZPermission.goSettingPage(context);
                RxPermissionUtil.toAppSetting(context);
                dialog.dismiss();
            }
        });
