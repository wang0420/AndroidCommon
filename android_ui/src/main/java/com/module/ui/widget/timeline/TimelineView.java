package com.module.ui.widget.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, DisplayUtil.dip2px(mContext,20 ));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, DisplayUtil.dip2px(mContext,2 ));
        ...
        if (mStartLine == null && mEndLine == null) {
            mStartLine = new ColorDrawable(mContext.getResources().getColor(R.color.blue));
