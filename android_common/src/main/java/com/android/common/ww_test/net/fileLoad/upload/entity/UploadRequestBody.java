package com.android.common.ww_test.net.fileLoad.upload.entity;
...
public class UploadRequestBody extends RequestBody {
    ...
    public UploadRequestBody(File file, UploadBodyListener progressListener) {
        this.mRequestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
        this.mProgressListener = progressListener;
    }

    public UploadRequestBody(RequestBody requestBody, UploadBodyListener progressListener) {
