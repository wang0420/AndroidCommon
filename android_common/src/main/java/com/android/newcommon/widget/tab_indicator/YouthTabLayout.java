 ...
 */
@ViewPager.DecorView
public class YouthTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link YouthTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link YouthTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public YouthTabLayout(Context context) {
        this(context, null);
    }

    public YouthTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YouthTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int indicatorMarginStart = ma.getDimensionPixelSize(
                R.styleable.TabIndicator_indicatorMarginStart, 0);
        int indicatorMarginEnd = ma.getDimensionPixelSize(
                R.styleable.TabIndicator_indicatorMarginEnd, 0);
        int indicatorMarginBottom = ma.getDimensionPixelSize(
                R.styleable.TabIndicator_indicatorMarginBottom, 0);
        int indicatorStartColor = ma.getColor(
                R.styleable.TabIndicator_indicatorStartColor, 0);
        int indicatorEndColor = ma.getColor(
                R.styleable.TabIndicator_indicatorEndColor, 0);
    ...
    /**
     * Add a {@link YouthTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link YouthTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link YouthTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link YouthTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * The one-stop shop for setting up this {@link YouthTabLayout} with a {@link ViewPager}.
     *
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mSelectedIndicatorPaint.getShader() == null || mIsColorDirty) {
                LinearGradient gradient = new LinearGradient(left, 0, right, 0, mStartColor, mEndColor, Shader.TileMode.CLAMP);
     ...
     * necessary calls back to the provided {@link YouthTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<YouthTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(YouthTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final YouthTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link YouthTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements YouthTabLayout.OnTabSelectedListener {
        ...
        @Override
        public void onTabSelected(YouthTabLayout.Tab tab) {
            mViewPager.setCurrentItem(tab.getPosition());
        }

        @Override
        public void onTabUnselected(YouthTabLayout.Tab tab) {
            // No-op
        }

        @Override
        public void onTabReselected(YouthTabLayout.Tab tab) {
            // No-op
        }
    }
